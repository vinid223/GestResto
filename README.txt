...
2. Allez dans l'onglet de PHPmyadmin pour importer un script SQL.
	2.1. Importez le script SQL fournit avec ce fichier nommé : scriptMySQL.sql
	2.2. La base de données est maintenant créée. Il faut laisser XAMP ouvert pour donner l'accès à GestResto.
	2.3. (Facultatif) Vous pouvez ajouter les données de démonstration en faisant la même opération que la 2.1 avec un autre fichier nommé : scripMysqlDonnees.sql
3. Ouvrir GestResto.
